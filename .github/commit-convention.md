...
The **header** is mandatory and the **scope** is optional. The related issue should be referenced at the end. All commits should reference an issue, except releases, dependency upgrades, and urgent fixes if absolutely necessary.
...
The scope can be anything specifying the place of the commit change. For example `dev`, `build`, `workflow`, `cli` etc...
